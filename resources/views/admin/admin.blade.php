...
<body class="bg-gray-100">
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 w-64 h-full bg-gray-800 text-white p-4 transform transition-transform duration-300 ease-in-out z-50 sm:-translate-x-0 hidden sm:block" aria-label="Sidebar">
